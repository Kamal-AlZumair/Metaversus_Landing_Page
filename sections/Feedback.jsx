    ...
    >
      ...
      >
        ...
        <div>
          ...
          <p className=' mt-[8px] font-normal sm:text-[18px] text-[12px] sm:leading-[22px] leading-4 text-white'>Founder | Metaversus</p>
        </div>
      ...
      >
        <Image src={plant} alt='plant-09' className='w-full lg:h-[610px] h-auto min-h-[210px] object-cover rounded-[40px]' />
