...
const ExploreCard = ({id, imgUrl, title, index, active, handleClick}) => (
  ...
  >
    <Image src={imgUrl} width={1920} height={1080} alt={title} className=' absolute w-full h-full object-cover rounded-[24px]' />
    {active !== id ? (
      ...
      <div className=' absolute bottom-0 p-8 justify-start w-full  flex-col bg-[rgba(0,0,0,0.5)] rounded-b-[24px]'>
        <div className='flex justify-center items-center w-[80px] h-[60px] rounded-[24px] glassmorphism mb-[16px]'>
          <Image src={headset} alt='headset' className=' w-1/2 h-1/2 object-cover'  />
        </div>
